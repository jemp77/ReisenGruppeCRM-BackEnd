...
namespace SmartCardCRM.Model.Models
{
    public class ClientDTO
    {
        ...
        public string WayOutTime { get; set; }

        public int CreditCardsCount { get; set; }
        public string CreditCardsFranchiseSum { get; set; }
        public string DateSpanishFormated { get; set; }
        public bool HasContract { get; set; }
        public List<ClientDebitCreditCardsDTO> ClientDebitCreditCards { get; set; }
        public List<ClientDebitCreditCardsDTO> CoOwnerDebitCreditCards { get; set; }
    }
}
